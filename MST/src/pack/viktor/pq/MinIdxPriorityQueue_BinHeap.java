...
/** 
* Klasa koja predstavlja tip indeksiranog reda sa prioritetom implementiran binarnim hipom.
* Klasa je genericka za tipove koji nasledjuju Comparable.
* @author Viktor Slavkovic 
* @param <Key> 
*/
public class MinIdxPriorityQueue_BinHeap<Key extends Comparable<Key>> {
	...
	*/
	...
	public MinIdxPriorityQueue_BinHeap(int maxSize, int maxIdxSize) {
	...
	* @throws	IllegalArgumentException		Ako vec postoji vrednost pod tim indeksom;
	*/
	...
	* @throws	RuntimeException		Ako se vrednost povecava ili ako nema vrednosti pod tim indeksom;
	*/
