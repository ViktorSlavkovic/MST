...
/** 
* Klasa koja implementira interfejs DisjointSet algoritmom Weighted Quick-Union with Path Compression
* @author Viktor Slavkovic 
*/
public class DisjointSet_WQUPC implements DisjointSet {
	...
	*/
	public DisjointSet_WQUPC(int n) {
		if (n < 0)
	...
	*/
	...
	/**
	 * Metod koji implementira operaciju unije; Kao sto je receno u radu, ova
	 * operacija stvara vezu izmedju dva elementa skupa.
	 * 
	 * @param idx1
	 *            Indeks prvog clana koji se povezuje;
	 * @param idx2
	 *            Indeks drugog clana koji se povezuje;
	 * @throws IndexOutOfBoundsException
	 *             Ako prosledjeni indeksi nisu validni;
	 */
	@Override
